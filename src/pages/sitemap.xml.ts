...
export const GET: APIRoute = async ({ site }) => {
  ...
  const urls = ['/', '/bn/', '/practice/', '/works/', '/artworks/', '/archive/', '/about/', '/contact/', '/privacy/', '/terms/', '/bn/practice/', '/bn/works/', '/bn/artworks/', '/bn/archive/', '/bn/about/', '/bn/contact/', '/bn/privacy/', '/bn/terms/', ...entries.map(entry => localPath(`/archive/${entry.data.translationKey}/`, entry.data.language))];
